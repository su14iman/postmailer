...
$emailPOST = sIO($_POST['username']);
$passwordPOST = sIO($_POST['password']);
    
      $loginFunction = $POSTMAILLER->login($emailPOST,$passwordPOST);
        if($loginFunction['s'] == 'ok'){
          // echo "ok";
          $_SESSION['username'] = en($emailPOST);
          $_SESSION['ID'] = en($loginFunction['id']);
          header('Location: ../'.$HomePageSession);
          exit();
        }else{
...
<head>
  ...
  <body class="align">
    ...
    <div class="grid">
      ...
      <p class="text--center">Forgot your password? <a href="Forgot">recovery</a> <svg class="icon"><use xmlns:xlink="http://www.w3.org/1999/xlink" ></use></svg></p>
